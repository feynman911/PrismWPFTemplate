...
namespace PrismWPFSample
{
    ...
    public partial class App
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterSingleton<CommonModels.CommonModel>();
        }
        ...
        protected override IModuleCatalog CreateModuleCatalog()
        {
            ...
            DirectoryModuleCatalog catalog;
            try
            {
                catalog = new DirectoryModuleCatalog() { ModulePath = @".\Modules" };
            }
            catch
            {
                catalog = new DirectoryModuleCatalog();
            }
            return catalog;
        }
